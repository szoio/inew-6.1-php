...
/**
 * GetOnlinePaymentProfilesResponse Class Doc Comment
 *
 * @category    Class
 * @description The fetch multiple payment profiles response.&lt;br&gt;
 * @package     iNew\Rest6_1
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetOnlinePaymentProfilesResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetOnlinePaymentProfilesResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'number_of_pages' => 'int',
        'page' => 'int',
        'payload' => '\iNew\Rest6_1\Model\OnlinePaymentProfileInfo[]',
        'provider_id' => 'int',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['number_of_pages'] === null) {
            $invalid_properties[] = "'number_of_pages' can't be null";
        }
        ...
        if ($this->container['records_per_page'] === null) {
            $invalid_properties[] = "'records_per_page' can't be null";
        }
     ...
     * @param int $number_of_pages the numberOfPages
     * @return $this
     */
    ...
    /**
     * Gets payload
     * @return \iNew\Rest6_1\Model\OnlinePaymentProfileInfo[]
     */
    ...
    /**
     * Sets payload
     * @param \iNew\Rest6_1\Model\OnlinePaymentProfileInfo[] $payload the payload
     * @return $this
     */
     ...
     * @param int $records_per_page the recordsPerPage
     * @return $this
     */
