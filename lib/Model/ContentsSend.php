...
/**
 * ContentsSend Class Doc Comment
 *
 * @category    Class
 * @package     iNew\Rest6_1
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ContentsSend implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContentsSend';
     ...
     * @param string $notification_key the notification key that defines which template to use for the notification (possible values are configurable and need to be retrieved from the configuration)
     * @return $this
     */
    ...
    /**
     * Sets parameters
     * @param map[string,string] $parameters the parameters as key value pairs
     * @return $this
     */
