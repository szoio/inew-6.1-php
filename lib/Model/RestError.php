 ...
 *
 * @category    Class
 * @description RestError is used as response in case of errors
 * @package     iNew\Rest6_1
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RestError implements ArrayAccess
{
    ...
    /**
     * Sets message
     * @param string $message the additional message for the response
     * @return $this
     */
