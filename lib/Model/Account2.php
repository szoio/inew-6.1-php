 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Account2 implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Account2';
     ...
     * @param int $amount_unit_relation Relation of the amount to the main unit of the currency
     * @return $this
     */
    ...
    /**
     * Sets currency_id
     * @param int $currency_id ID of currency
     * @return $this
     */
    ...
    /**
     * Sets currency_name
     * @param string $currency_name Name of currency associated with the amount
     * @return $this
     */
    ...
    /**
     * Sets unit_id
     * @param int $unit_id ID of currency unit
     * @return $this
     */
