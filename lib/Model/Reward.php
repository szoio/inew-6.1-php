 ...
 *
 * @category    Class
 * @description A reward defined as an amount of units of some currency and having a specific expire period
 * @package     iNew\Rest6_1
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Reward implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'expiry_period' => '\iNew\Rest6_1\Model\Period1'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['expiry_period'] = isset($data['expiry_period']) ? $data['expiry_period'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['expiry_period'] === null) {
            $invalid_properties[] = "'expiry_period' can't be null";
        }
    ...
    /**
     * Sets amount
     * @param int $amount Amount of rewarded units
     * @return $this
     */
    ...
    /**
     * Sets expiry_period
     * @param \iNew\Rest6_1\Model\Period1 $expiry_period Expire period
     * @return $this
     */
