...
class PaymentMethod implements ArrayAccess
{
    ...
    /**
     * Sets opp_id
     * @param int $opp_id the online payment profile ID that should be used as a payment method, if not provided the main balance (e.g. of the prepaid account) will be used for the payment
     * @return $this
     */
