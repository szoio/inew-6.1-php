...
/**
 * GetSecurityStatusResponse Class Doc Comment
 *
 * @category    Class
 * @package     iNew\Rest6_1
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetSecurityStatusResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetSecurityStatusResponse';
    ...
    /**
     * Sets payload
     * @param bool $payload a boolean indicating whether security is enabled (true) or disabled (false)
     * @return $this
     */
