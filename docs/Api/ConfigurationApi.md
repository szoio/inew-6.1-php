...
[**administrationRestExporterAdministrationGetAvailableVersions**](ConfigurationApi.md#administrationRestExporterAdministrationGetAvailableVersions) | **GET** /configuration/openRestApi/versions | returns the list of all available API versions for the given access key
...
try {
    ...
    echo 'Exception when calling ConfigurationApi->administrationRestExporterAdministrationSetConfiguration: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ConfigurationApi->administrationRestExporterAdministrationUpdateSettings: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ConfigurationApi->crceAccountGetAccountDescriptor: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ConfigurationApi->crceAccountGetAccountDescriptors: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ConfigurationApi->crceOverdraftGetOverdraftConfiguration: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ConfigurationApi->crceProviderGetProviders: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ConfigurationApi->snaSubscriberNotificationAdministrationServiceGetCategories: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ConfigurationApi->snaSubscriberNotificationAdministrationServiceGetNotificationsConfiguration: ', $e->getMessage(), PHP_EOL;
}
?>
```
